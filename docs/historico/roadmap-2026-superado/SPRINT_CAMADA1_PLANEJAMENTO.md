> ⛔ **SUPERADO — documento histórico, não use como referência.**
>
> Arquivado em 2026-09-09 (item A5 do plano de recuperação). Este arquivo
> apresenta como *futuro a decidir* coisas que já foram decididas e
> implementadas (a "Camada 1" de nós declarativos, o Hub virando Graph
> Studio), e descreve um sistema que não existe mais desde a ADR 0008.
>
> Foi mantido porque registra o raciocínio da época, não porque ainda vale.
>
> **O v1 é um bot de menu.** O que o sistema é hoje:
