...
Renomeada em 2026-09-10: o id anterior, `022_route_registry_escalar_humano`,
tinha 33 caracteres e a coluna `alembic_version.version_num` é `varchar(32)`.
O `UPDATE` do bookkeeping estourava com `StringDataRightTruncationError`, e a
transação inteira revertia — ou seja, **esta migration e todas as seguintes
nunca puderam ser aplicadas em banco nenhum**, aqui ou em produção. Encurtar
o id conserta em qualquer ambiente; alargar a coluna consertaria só um.

Revision ID: 022_route_registry_escalar
...
revision: str = "022_route_registry_escalar"
