"""
Gatekeeper — Portão de entrada do Celery (ex `application/routing/message_router.py`).
...
FLUXO:
  ...
  5. LLMDispatch      → @oraculo ou privado → Supervisor (router/supervisor.py)

Gate regex puro, sem IO/LLM — mantido quase inalterado por ser um bom modelo
de estilo (ver seção 1 do PLANO_REFATORACAO_SUPERVISOR.md), só mudou o
namespace de import.
"""
