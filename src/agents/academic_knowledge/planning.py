"""
src/agents/academic_knowledge/planning.py
============================================
Ex `application/chain/planner.py` (Fase 4 do PLANO_REFATORACAO_SUPERVISOR.md,
seção 2.4). Comportamento idêntico, só relocado — exceto que a whitelist de
workers válidos agora vem de `router/contracts.py::VALID_WORKERS` (fonte
única), em vez de estar duplicada aqui como set solto.
"""
...
from src.router.contracts import VALID_WORKERS
