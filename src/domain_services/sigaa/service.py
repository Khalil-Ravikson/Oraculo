"""
src/domain_services/sigaa/service.py
==============================
...
matrícula (via `domain_services/sigaa/eligibility.py`).
...
`rag/knowledge/service.py` na Fase 4: ainda NÃO é o caminho
...
from src.domain_services.sigaa import eligibility
